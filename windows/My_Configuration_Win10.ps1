#####################################################################
#  Nom du Script  Paramétrage sécurisé de Windows
#  Créer le    26/01/2020
#  Auteur : Freijanes Christophe
#  Version : 1.0
#  Action du script : Permet de sécuriser, optimiser Windows
...
$tweaks = @(
	...
	# "SetControlPanelSmallIcons",  # "SetControlPanelLargeIcons",  
